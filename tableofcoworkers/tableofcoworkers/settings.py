"""
Django settings for tableofcoworkers project.
...
SECRET_KEY = 'django-insecure-whs&%tq-yz3zm78vs%xz7xbkez96%#yj3=&!w-=+6-3(7h+3zl'
...
ROOT_URLCONF = 'tableofcoworkers.urls'
...
WSGI_APPLICATION = 'tableofcoworkers.wsgi.application'
